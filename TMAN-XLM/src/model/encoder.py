...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, emb_dim, n_heads=8, n_layers=1, dropout=0.2, attention_dropout=0.2):
        """
        ...
        for _ in range(self.n_layers):
            ...
            self.ffns.append(TransformerFFN(self.dim, self.hidden_dim, self.dim, dropout=self.dropout, gelu_activation=True))
